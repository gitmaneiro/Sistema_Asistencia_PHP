...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(20, 10, utf8_decode('EMPLEADO'), 1, 0, 'C', 1);
...
foreach ($datos as $dato) {
   $pdf->Cell(18, 10, utf8_decode($dato['id_empleado']), 1, 0, 'C', 0);
   $pdf->Cell(20, 10, utf8_decode($dato['n_empleado']), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($dato['dni']), 1, 0, 'C', 0);
   $pdf->Cell(25, 10, utf8_decode($dato['cargo']), 1, 0, 'C', 0);
