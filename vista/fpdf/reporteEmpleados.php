...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(45, 10, utf8_decode('CARGO'), 1, 1, 'C', 1);
...
foreach ($datos as $dato) {
   $pdf->Cell(15, 10, utf8_decode($dato['id_empleado']), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, utf8_decode($dato['nombre']), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, utf8_decode($dato['apellido']), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($dato['dni']), 1, 0, 'C', 0);
   $pdf->Cell(45, 10, utf8_decode($dato['cargo']), 1, 1, 'C', 0);
